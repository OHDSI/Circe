define(['knockout', '../options', '../InputTypes/Range', '../InputTypes/Text', 'text!./ConditionOccurrenceTemplate.html'], function (ko, options, Range, Text, template) {
	...
	function ConditionOccurrenceViewModel(params) {
		...
		var addActions = [
			{
				text: "Add Condition Start Date Criterion",
				selected: false,
			...
			{
				text: "Add Condition End Date Criterion",
				selected: false,
			...
			{
				text: "Add Condition Type Criterion",
				selected: false,
			...
			{
				text: "Add Condition Source Concept Criterion",
				selected: false,
